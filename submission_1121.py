...
class GameState():
            ...
            if pathClear:
                ...
                if dAngle < 30 and rho > 25:
                    ...
                    for tm in self._position_polar:
                        if tm[0] < 15 and abs(angleBetween(tm[1],self._player_heading)) < 15:
    ...
    def _evaluateOptions(self):
        ...
        if self._player_position[0] < -30 and (currentRisk > 25 or inSmallBox(self._player_position,dir=-1, extend_x=2)):
    ...
    def _defend(self):
        ...
        if self._ball_speed < 0.01:
            return self._meetBall()
        if self._ball_polar[0] < 2 and abs(self._ball_polar[1]) < 70 and inBox(self._player_position, dir=-1):
